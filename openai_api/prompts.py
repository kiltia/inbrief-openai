...
SUMMARIZE_TASK = "Тебе необходимо суммаризовать текст в новый текст, сохранив только САМЫЕ основные моменты повествования"

TITLE_TASK = "Тебе будет дан набор текстов, принадлежащих к одному сюжету. Тебе будет необходимо выделить общие черты сюжета и придумать новостной заголовок для него. Отвечай только самим заголовком"
