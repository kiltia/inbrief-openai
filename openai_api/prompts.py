...
SUMMARIZE_TASK = "Тебе необходимо суммаризовать новостной сюжет в новый текст, сохранив только САМЫЕ основные и САМЫЕ важные для читателя фрагменты сюжета. Суммаризация должна быть значительно меньше оригинального текста, при этом она также должна быть логически и грамматически связной, чтобы результат должно быть приятно и легко читать. Отвечай только суммаризацией, не добавляй никаких дополнительных пояснений."
